...
/* =====================================================
   HALLOWEEN LORE LOGIN
   ===================================================== */

const HALLOWEEN_USERNAME = "HalloweenAdmin";
const HALLOWEEN_PASSWORD = "Halloween2026";

function openHalloweenLogin() {

    const overlay =
        document.getElementById(
            "halloween-login-overlay"
        );
    ...
    document
        .getElementById("halloween-username")
        .focus();
}


function closeHalloweenLogin() {
...
function checkHalloweenLogin() {
    ...
    const error =
        document.getElementById(
            "halloween-login-error"
        );


    if (
        username === HALLOWEEN_USERNAME &&
        password === HALLOWEEN_PASSWORD
    ) {

        sessionStorage.setItem(
            "halloweenLoreUnlocked",
            "true"
        );
...
function unlockHalloweenLore() {

    const locked =
        document.getElementById(
            "halloween-lore-locked"
        );

    const secret =
        document.getElementById(
            "halloween-secret-lore"
        );
...
/* Restore access during this browser session */
